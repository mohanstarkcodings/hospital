...
// show all jobs in the database (GET /jobs?page=1&limit=10)
...
// Search Jobs (GET /jobs/search?job title or description or skills or location or combination of this)
...
// filter Jobs (GET /jobs/filter?location=xxx& work mode=xxx & jobType= xxx & experience_required=xxx)
...
//View All Posted Jobs (GET /jobs/my?page=1&limit=10)
...
//View Job Details  (GET /jobs/:jobId)
